...
from src.module.db_module.models import CollectionItem, KbFile
from src.module.db_module.service import DBService
from app import EmbeddingService
from src.shared.parse.parse_service import ParseService

logger = logging.getLogger(__name__)


@service(name="collection_service_impl", deps=[DBService, EmbeddingService])
