...
class KbRouter:
    ...
    async def list_kbs(
        ...
        return await self.svc.list_user_kbs(user, current, size)
    ...
    async def list_public(
        ...
        return await self.svc.list_public_kbs(current, size, keyword)
    ...
    async def update(self, kb_id: str, req: UpdateKbRequest, user=Depends(get_current_user)):
        return await self.svc.update_kb(kb_id, user, req)
    ...
    async def join(self, kb_id: str, user=Depends(get_current_user)):
        return await self.svc.join_kb(kb_id, user)
